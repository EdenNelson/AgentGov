---
name: standards-orchestration
description: Orchestration rules, consent gates, and change management standards.
---

This skill mirrors STANDARDS_ORCHESTRATION.md. Keep this content in sync with the canonical file.
...
1. **Thinking Phase:** Analyze, Assess, Draft Plan, Persist, Approve
...
5. **Audit Trail:** Commits link back to plan; audit trail is complete
