...
description: Pragmatic Architect persona and behavioral rules for default mode.
---

This skill mirrors PERSONA.md. Keep this content in sync with the canonical file.
