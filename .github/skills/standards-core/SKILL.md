---
name: standards-core
description: Core and orchestration standards for all work in this repository.
---

This skill mirrors STANDARDS_CORE.md. Keep this content in sync with the canonical file.
